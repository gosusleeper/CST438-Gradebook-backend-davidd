...
public class JunitTestGradebook {
	...
	@Test
	public void deleteAssignmentValid() throws Exception {
		...
		// change this line, delete the assignment
		response = mvc.perform(MockMvcRequestBuilders.delete("/assignment/delete/1").accept(MediaType.APPLICATION_JSON))
				.andReturn().getResponse();
	...
	@Test
	//existing grades should fail
	public void deleteAssignmentInvalid() throws Exception {
	...
	public void deleteAssignmentDoesNotExist() throws Exception {
		...
		// change this line, delete the assignment
		// delete assignment 2 doesn't exist
		response = mvc.perform(MockMvcRequestBuilders.delete("/assignment/delete/2").accept(MediaType.APPLICATION_JSON))
				.andReturn().getResponse();
